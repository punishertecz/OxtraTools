...
from src.OxtraTools import OxtraTools
import argparse
...
parser = argparse.ArgumentParser(description='OxtraTools is a OSINT tool on Instagram. It offers an interactive shell '
